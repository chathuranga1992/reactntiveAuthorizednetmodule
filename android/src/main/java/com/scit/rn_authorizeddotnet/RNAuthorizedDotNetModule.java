package com.scit.rn_authorizeddotnet;
...
public class RNAuthorizedDotNetModule extends ReactContextBaseJavaModule {
  ...
  public RNAuthorizedDotNetModule(ReactApplicationContext reactContext) {
    super(reactContext);
  ...
  private EncryptTransactionObject prepareTransactionObject(ReadableMap cardValue) {
    ...
    return TransactionObject.createTransactionObject(
